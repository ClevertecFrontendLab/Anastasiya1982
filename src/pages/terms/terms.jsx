...
export const TermsPage = ({contentView}) => {

    const title=contentView==='terms'? 'Правила пользования' : 'Договор офферты'
            ...
            <li className='article-title'>
              ...
              <ol className='subtitle'>
                ...
                <li>
                  ...
                  непростую экономическую ситуацию, объявлены нарушающими общечеловеческие нормы этики и морали. t
                </li>
                <li>
